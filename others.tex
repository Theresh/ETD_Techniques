...
\author{Theresh Babu Benguluri,Sandeep Kumar,Siddharth Mourya,Sai Manasa,Raktim Goswami,Abhishek Bairagi , G V V Sharma$^{*}$% <-this % stops a space
...
Fig. \ref{fig:inter} shows the various interleaving methods.
\begin{figure}
\begin{center}
\includegraphics[width=\columnwidth]{/bit_inter}
\end{center}
\caption{Bit Interleaver Structure for various mapping schemes}
\label{fig:inter}
\end{figure}
